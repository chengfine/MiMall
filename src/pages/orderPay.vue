<template>
    <div class="order-pay">
                ...
                <div class="order-wrap">
                    ...
                    <div class="item-detail" v-show="showDetail">
                        ...
                        <div class="item">
                            ...
                            <div class="dateil-info">电子发票 个人</div>
                        </div>
                    </div>
                </div>
                <div class="item-pay">
        ...
        <scan-pay-code v-if="showPay" @close="closePayMedal" :img="payImg">
              ...
              if(payType == 1){
                ...
                this.axios.post('/pay',{
                    ...
                    QRCode.toDataURL( res.content ).then(url => {
                      ...
                      this.$message.error("支付二维码生成失败,请稍后重试!")
                    })
                })
              }
            },
