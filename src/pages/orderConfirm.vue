        ...
        <div class="order-box">
          <div class="item-address">
            ...
            <div class="addr-list clearfix">
              <div
                class="addr-info" :class="{'checked': index == checkIndex}" @click="checkIndex = index" v-for="(item, index) in list" :key="index"
              >
              ...
              <div class="addr-add" @click="openAdressModal">
...
export default {
  ...
  data(){
      return {
          ...
          count: 0, // 商品结算数量
          checkedItem: {}, // 选中的商品对象
          userAction: '', // 记录用户行为 0: 新增   1: 编辑   2: 删除
